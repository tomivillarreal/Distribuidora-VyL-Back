...
export class Init1687722292367 implements MigrationInterface {
    name = 'Init1687722292367'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "estante" DROP COLUMN "nombre"`);
        await queryRunner.query(`ALTER TABLE "estante" ADD "nombre" character varying NOT NULL`);
